...
class DriveUploader:
    ...
    def _authenticate(self) -> bool:
        ...
        try:
            ...
            if not service_account_info and self.config:
                creds_path = self.config.get('system.gdrive_creds_path')
    ...
    def upload_file(self, file_path: str, folder_id: Optional[str] = None) -> Optional[str]:
        ...
        try:
            ...
            if folder_id:
                ...
                # Try to get default folder ID from config
                config_folder_id = self.config.get('system.gdrive_folder_id')
                if config_folder_id:
                    file_metadata['parents'] = [config_folder_id]
