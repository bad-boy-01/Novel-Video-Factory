...
class ScenePlanner:
    ...
    def plan_scenes(self, text_chunk: str) -> List[Dict]:
        ...
        system_prompt = (
            ...
            "[{\"scene_id\": \"SC001\", \"visual_prompt_tags\": \"1boy, waking up, confused\", \"narration_text\": \"John woke up with a start, totally confused.\", \"characters_present\": [\"John\"], \"camera_angle\": \"close up\", \"lighting\": \"morning sunlight\"}]"
        )
