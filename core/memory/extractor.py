...
class MemoryExtractor:
    ...
    def extract_all(self, text_chunk: str, existing_characters: List[Dict] = None, existing_relationships: List[Dict] = None) -> Dict[str, List[Dict]]:
        ...
        system_prompt = (
            ...
            "EXISTING RELATIONSHIPS: " + existing_rel_list + "\n\n"
            "CRITICAL RULES FOR CHARACTERS:\n"
            "1. You MUST use detailed Danbooru-style tags for 'visual_dna' (age, hair, eyes, facial features, body type, clothing).\n"
            "2. If a character is in the EXISTING list, only provide new visual details if found; otherwise reuse their known features to maintain consistency.\n"
            "3. DNA must be unique and descriptive (e.g., 'silver hair, piercing blue eyes, tall, slender, embroidered white silk robe').\n"
            "4. DO NOT extract locations as characters.\n\n"
            "CRITICAL RULES FOR RELATIONSHIPS:\n"
            "1. Identify connections (e.g., 'master-disciple', 'family', 'enemy').\n"
            "2. DO NOT downgrade relationships (e.g., from 'brother' to 'friend').\n\n"
            "EXAMPLE OUTPUT FORMAT:\n"
            "{\n"
            "  \"characters\": [{\"canonical_name\": \"Xu Changshou\", \"visual_dna\": {\"age\": \"6 years old\", \"hair\": \"short black hair\", \"eyes\": \"dark brown eyes\", \"clothing\": \"tattered ancient linen rags\"}}],\n"
            "  \"locations\": [...],\n"
            "  \"world_concepts\": [...],\n"
